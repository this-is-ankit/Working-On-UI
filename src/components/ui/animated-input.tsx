    ...
    <div className="relative">
      ...
      >
        <input
          {...props}
          className={cn(
            "w-full px-4 py-3 text-gray-700 bg-white border-2 border-gray-200 rounded-xl transition-all duration-300 focus:border-blue-400 focus:ring-4 focus:ring-blue-100 focus:outline-none placeholder-transparent peer",
